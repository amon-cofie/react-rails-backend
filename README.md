...
**React Rails** is the backend of a ruby-on-rails-react web application on a postgreSQL database that is built to display a random greeting to a user.
...
- **API that returns a random greeting**
...
```sh
  cd [my-folder]
  git clone git@github.com:amon-cofie/react-rails-backend.git
